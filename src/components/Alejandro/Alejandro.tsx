                  ...
                  <ol className="group/list">
                    {jobs?.map((job, i) => (
                      <li className="mb-12" key={i}>
                        <div className="group relative z-0 grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4">
                ...
                <div>
                  ...
                  <ul className="group/list">
                    ...
                    {projectsArr?.map((project, i) => (
                      <li className="mb-12" key={i}>
                        <div className="group relative z-0 grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 ">
