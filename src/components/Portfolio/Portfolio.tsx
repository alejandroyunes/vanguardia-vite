    ...
    <PortfolioContainer>
      ...
      <div className="portfolio-billboard">
        ...
        <div className="child-two">
          <img src={punkies} alt="imagen uno portafolio" />
        </div>
      </div>
      <div className="portfolio-billboard-two">
        <div className="child-one">
          <img src={drPuerta} alt="imagen dr puerta portafolio" />
        </div>
        <div className="child-two">
          <h1>Dr. Puerta</h1>
          <h2>
      ...
      <div className="portfolio-billboard">
        ...
        <div className="child-two">
          <img src={portfolioRestaurant} alt="imagen restaurante japones" />
        </div>
      </div>
      <div className="portfolio-billboard-two">
        <div className="child-one">
          <img src={iphoneCase} alt="iphone porfolio image four" />
        </div>
        <div className="child-two">
          <h1>iPhone 13</h1>
          <h2>
      ...
      <div className="portfolio-billboard">
        ...
        <div className="child-two">
          <img src={hotels} alt="imagen hoteles portafolio" />
        </div>
      </div>
    </PortfolioContainer>
  )
