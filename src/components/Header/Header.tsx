...
// function Header() {
//   const [header, setHeader] = useState("header-container")
...
//       return setHeader("header-container")
//     } else if (window.scrollY > 70) {
//       return setHeader("header-slide-down")
//     }
//   };
...
//               className="chk"
//               id="chk"
//               onChange={() => console.log('on click dark mode')}
//             />
          ...
          <div className="header__links-wrapper">
            ...
            <div className="header__toggle__dark_mode_container">
              <div className="dark-toggle-input">
                ...
                />
                <label htmlFor="chkd" className="toggle">
                  <span className="star star1"></span>
                  <span className="star star2"></span>
                  <span className="star star3"></span>
                  <span className="star star4"></span>
            ...
            <ul className="header__links-wrapper">
              ...
              <li className="header__link__item">hello</li>
              <li className="header__link__item">world</li>
            </ul>
          </div>
